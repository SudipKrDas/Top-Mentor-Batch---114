...
5. Zip the datasets folders separately for Delivery and Salary Hike.
6. Write proper print statements while writing the code. Proper rounding of the numbers is also required.
7. Prepare a presentation for both the projects separately. The presentation should contain - 
	1. Objective
	2. Solution 
	3. Business Impact
8. Save the Code and download it as .ipynb format - with its name "Delivery_prj1" and "salary_prj2"
8.1 - Also create the models in excel as shown in the class and upload it in the same repo of github mentioned.
9. Prepare a Word Doc for the entire end to end process with solution architecture and methodology. Also mention the time taken
...
11. In the same readme file mention the details about both the use cases and mention the tools and the insights gathered.
12. Add some relevant key words for the repo.
